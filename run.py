...
def update_worksheet(data, worksheet):
    """
    Update a worksheet, add new row with the list data provided.
    """
...
def get_last_5_entries_sales():
    """
    Get the last 5 entries of sales data from the sales worksheet.
    """
...
def calculate_stock_data(data):
    """
    Calculate the average stock for each sandwich type.
    """
